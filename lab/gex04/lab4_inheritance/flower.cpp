...
: stem(Vector2(center.x(), center.y() + STEM_HEIGHT / 2), STEM_COLOR, STEM_WIDTH, STEM_HEIGHT),
	...
	leaf(
		LEAF_COLOR,
		Vector2(center.x() - STEM_WIDTH/2 + 1, center.y() + STEM_HEIGHT / 2),                   // Tip of the leaf
		Vector2(center.x() - STEM_WIDTH/2 + 1 - LEAF_WIDTH, center.y() + STEM_HEIGHT / 4),     // Left point
		Vector2(center.x() - STEM_WIDTH/2 + 1 - LEAF_WIDTH / 2, center.y() + STEM_HEIGHT / 2)  // Bottom point
	)
{
